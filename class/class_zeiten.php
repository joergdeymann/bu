...
class zeiten {
	...
	private int $sum_minutes=0;       // Arbeits-Stunden 60 Minuten * 24 h *30 Tage = Maximal 43.200: int 32 Bit >= 2.147.483.647
	private int $sum_pause=0;         // Arbeits-Pausen  
	private int $sum_overminutes=0;   // Über Minuten
	private int $sum_underminutes=0;  // unter Minuten
	
									  // Tagesstunden:
	private int $sum_day_minutes=0;   // Arbeits stunden
	private int $sum_day_pause=0;     // Arbeits pausen (in minuten)
	
	private DateTime $dt_AS;          // Arbeits start
	private DateTime $dt_AE;          // Arbeits ende
