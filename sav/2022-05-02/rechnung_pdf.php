...
/*
$xkey="$re['name']";
$content=str_replace($xkey,$name,$content);
$content=str_replace($xkey,$name,$content);
*/

// echo '<div style="width:80%;border 5px red solid;margin-left:20%;"><h1>x</h1>';
echo $content;
// echo "</div>";
	...
	// $dompdf->set_base_path('localhost/FasilTamiz/rechnung.css');
