...
$sig.= '<table><tr><td><a href="https://www.die-deymanns.de/VA/leistungen.html"><img src="img/logo.png"></a></td><td>Jörg Deymann</td></tr></table>';


$m = new sendmail();
$m->setSubject("Test 14 Message mit miltipart/mixed");
...
class sendmail {
	...
	private $textmessage="";   //Falls HTML doch nicht akzeptiert wird
