...
<center>
<form action="artikel_liste.php" method="POST">
...
<?php
	...
	while($row = $result->fetch_assoc()) {		
		$action="";
		$action ='<form style="display:inline;marginm:0;padding:0;"><input type = "hidden" name="artikelnr" value="'.$row['artikelnr'].'">';
		$action.='<input type = "submit" value="bearbeiten" name="find_artikelnr" formmethod="POST" formaction="artikel.php"></form>';
