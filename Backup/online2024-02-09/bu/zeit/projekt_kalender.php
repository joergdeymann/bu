...
$html.= $kalender->show();
$html.='<center>';
$html.='<input type="submit" value="RESET" name="reset" formaction="projekt_kalender.php#P1" style="font-weight:bold;margin-top:5px;margin-bottom:5px;padding-left:10px;padding-right:10px;">';
$html.='<input type="submit" value="WEITER" name="'.$button.'" formaction="projekt_kalender.php#P1" style="font-weight:bold;margin-top:5px;margin-bottom:5px;margin-left:10px;margin-right:10px;padding-left:10px;padding-right:10px;">';
$html.='<input type="submit" value="OOPS" name="undo" formaction="projekt_kalender.php#P1" style="font-weight:bold;margin-top:5px;margin-bottom:5px;padding-left:10px;padding-right:10px;">';
$html.='</center>';
$html.='</div>';
$html.= '<br>';
...
switch($pressed_btn) {
	case 0:
		$style='vertical-align:middle; border:1px solid black;border-radius:25px;font-weight:bold;margin:0;padding:0; min-width:120px;cursor:pointer;'.$height;
		$html.= '<button '.$action.' id="kalendertag2" type="submit" name="btn_licht"   value="'.$licht1.'"  style="'.$style.';background-color:'.$licht1.';">Licht</button>';
		$html.= '<button '.$action.' id="kalendertag2" type="submit" name="btn_ton"     value="'.$ton1.'"    style="'.$style.';background-color:'.$ton1.  ';">Ton</button>';
		$html.= '<br>'; 
		$html.= '<button '.$action.' id="kalendertag2" type="submit" name="btn_sperr"   value="'.$sperr.'"   style="'.$style.';background-color:'.$sperr. ';">Krank<br>Familie</button>';
		$html.= '<button '.$action.' id="kalendertag2" type="submit" name="btn_schul"   value="'.$schul.'"   style="'.$style.';background-color:'.$schul. ';">Schulung<br>sonstiges</button>';
		break;
	case 1:
		$style.='background-color:'.$c.';'.$height;
		// echo $style;echo "<br>";		
...
// $html.='</div>';
$html.='<datalist id="kunden">';
$html.='<option value="ME Event">';
$html.='<option value="Acoustic Network">';
$html.='<option value="Die Deymann\'s">';
$html.='</datalist>';
...
if (!empty($_POST['anreise']) or !empty($_POST['abreise'])) {
	$html.='<tr><td>Fahrtkostenerstattung: </td><td><input '.$action.' name="fahrtkosten_ja" value="Ja" type="submit" style="width:5em;'.$color1.'"><input '.$action.' name="fahrtkosten_nein" value="Nein" type="submit" style="width:5em;'.$color2.'"></td></tr>';
}
if ($_POST['fahrtkosten_erstattung'] != 1) {
...
$html.='<datalist id="equipment">';
$html.='<option value="Mischpult Soundcraft">';
$html.='<option value="Mischpult Alan&Heath">';
$html.='<option value="Mischpult Scoby">';
$html.='</datalist>';
...
if ($_POST['unterkunft_gestellt'] == 1) {
	...
	$html.='<datalist id="unterkunft">';
	$html.='<option value="Maritim Hotel Hamburg">';
	$html.='<option value="IBIS Hotel Duisburg">';
	$html.='<option value="Die Linde Markkleeberg">';
	$html.='</datalist>';
}
$html.='</fieldset>';

$html.='<fieldset style="margin-bottom:5px;padding-bottom:2px;padding-left:2px;padding-right:0px;"><legend>Notizen</legend>';
$autofocus="";
if ($focus == 6) {
	$autofocus="autofocus";
}
$html.='<textarea '.$autofocus.' name="info" style="width:calc(100% - 16px);height:5em;">'.$_POST['info'].'</textarea>';
$html.='</fieldset>';
