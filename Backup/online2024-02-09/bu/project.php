...
echo '</form>';
echo '<div id="menu" style="border-top:red solid 4px;"><a id="button" href="zeiterfassung.php">Zeiten</a><a id="button" href="project.php">Projekt</a><a id="button" href="chat.php">Nachricht</a></div>';
