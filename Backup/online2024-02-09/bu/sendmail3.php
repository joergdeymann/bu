<?php
$sig='<img src="mail/testimg.jpg"> Hallo das gehört dazu';
$m = new Send();
$m->addAttachment("img/all-transport24.gif");
$m->setSignature($sig); 
$m->send();
echo "Gesendet<br>";
exit;
...
Here's an example of what you might add to your php.ini file when using sendmail:

Setting 		Value 				Description
SMTP 			localhost 			Set this to localhost
smtp_port 		25 					The port number to use for the sendmail program
sendmail_from 	me@example.com 		The default email address for the 'from' field
sendmail_path 	/usr/sbin/sendmail 	The path to your sendmail program
