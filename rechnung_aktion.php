...
from bu_re 
left join bu_re_posten on bu_re.renr=bu_re_posten.renr and bu_re.firmanr='$fn' and bu_re.typ='0' 
left join bu_kunden on bu_re.kdnr=bu_kunden.kdnr  and bu_re.firmanr='$fn' 
where bu_re.renr='$rn' and bu_re.firmanr='$fn' and bu_re.typ='0';
";
...
$request="select * from bu_mahn 
		  ...
		  where bu_mahn.renr='".$_POST['renr']."' 
		  and bu_mahn.firmanr='".$_SESSION['firmanr']."' 
...
$latest_mahnstufe=(int)0; //$latest vorher
$zeilen="";
$mahngebuehr=0;
...
?>
<!--
<iframe id="PDF" style="position:absolute;right:1%;top:30%;display:none;width:210px;height:300px;scale: 1.0;"></iframe>
<!--	t iframe id="PDF" style="position:absolute;right:0;bottom:0;display:none;width:200px;height:280px;"></iframe -->
<iframe id="PDF" style="position:absolute;right:-100px;top:250px;display:none;width:420px;height:600px;transform:scale(0.5);origin:bottom left;"></iframe>
...
<button type="submit" name="mailto" formaction="rechnung_versenden.php" formmethod="POST" formtarget="_blank"><?php echo $row_next['name']; ?><br>per<br>Mail</button>
<!-- ?php } ?-->
...
<script>
	...
	function printPDF() {
		...
		var file="rechnung_printed.php?typ=0&renr="+renr+"&mahnstufe="+mahnstufe+"&faellig="+mahndatum;
...
showBottom();
if ($mahnvorlage) {
	$file="rechnung_print.php?typ=0&renr=".$row['renr']."&mahnstufe=".$row_next['mahnstufe']."&firmanr=".$_SESSION['firmanr'];
	// echo $file;exit;
	echo "<script>";
	echo "setPDF('$file');";
	echo "</script>";
